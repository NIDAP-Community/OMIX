...
function_file <- file.path(module_dir, "R", "Volcano_Plot_Enhanced.R")
cli_file <- file.path(module_dir, "scripts", "run_volcano_plot.R")
...
message("OMIX-Volcano-Plot module layout checks passed")
