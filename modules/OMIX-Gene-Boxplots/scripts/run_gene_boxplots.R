...
option_list <- list(
  ...
  make_option("--y_axis_label", type = "character", default = "auto", help = "auto or a shared y-axis label [default: %default]"),
  make_option("--colors", type = "character", default = "", help = "Optional comma-separated original named colors"),
